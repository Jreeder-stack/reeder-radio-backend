...
export default function ScanMonitorPage() {
  const { isScanning, toggleScanning, scanChannels, setScanChannels, toggleScanChannel } = useRadio();
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-6 bg-zinc-900/50 border-b border-white/5 flex flex-col items-center gap-4">
          <div className="relative">
            ...
            {isScanning && (
              <div className="absolute inset-0 w-full h-full border-t-2 border-emerald-400 rounded-full animate-spin [animation-duration:2s]" />
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {isLoading ? (
              ...
              scanChannels.map((ch) => (
                <div 
                  key={ch.id}
                  data-testid={`scan-channel-${ch.id}`}
                  className={cn(
