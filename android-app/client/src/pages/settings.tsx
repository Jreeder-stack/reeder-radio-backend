...
let dndStateSetters: {
  setDndPermissionGranted: (granted: boolean) => void;
  ...
  return (
    <MobileFrame title="SYSTEM SETTINGS">
      <div className="p-4 space-y-6">
          ...
          <div className="bg-zinc-900/50 rounded-xl border border-white/5 overflow-hidden">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                <span className={`text-xs font-bold ${capturingPtt ? 'text-yellow-400 animate-pulse' : 'text-primary'}`}>
            ...
            <SettingItem 
              ...
              action={
                <Switch 
                  ...
                  data-testid="toggle-background-gps"
                />
              }
            />
            ...
            <SettingItem 
              ...
              action={
                <Switch 
                  ...
                  data-testid="toggle-background-audio"
                />
              }
            />
        ...
        {/* Mission-Critical Alert Override Section - Android only */}
        {isNative && (
        <section className="space-y-3">
            ...
            <SettingItem 
              ...
              action={
                <Switch 
                  ...
                  data-testid="toggle-dnd-override"
                />
              }
            />
                ...
                <SettingItem 
                  ...
                  action={
                    <Switch 
                      ...
                      data-testid="toggle-dnd-emergency"
                    />
                  }
                />
                ...
                <SettingItem 
                  ...
                  action={
                    <Switch 
                      ...
                      data-testid="toggle-dnd-officer-down"
                    />
                  }
                />
              </>
        ...
        <Button 
          variant="outline" 
          className="w-full border-red-900/50 text-red-500 hover:bg-red-950/30 hover:text-red-400"
